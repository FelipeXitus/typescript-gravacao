...
router
  ...
  .put("/:pet_id/adotante/:adotante_id", verificaIdMiddleware, (req, res) => petController.adotaPet(req, res))
  .put("/:pet_id/abrigo/:abrigo_id", verificaIdMiddleware, (req, res) => petController.alocaPetAbrigo(req, res))
